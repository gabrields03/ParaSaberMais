...
.w3-sidebar {width: 10%;background: #0d47a1;}
...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center"style=" color:white;">
  ...
  <a href="../../pages/inicial/index.php" class="w3-bar-item w3-button w3-padding-large w3-hover-blue ">
    <i class="fa fa-home w3-xlarge"></i>
      <H6><font face='agency fb w3-small'><p>CASA</p></font></H6>
  </a>
  ...
  <a href="" class="" style="text-decoration:none">
    <i class="fa fa-eye w3-xlarge" style="color:white"></i>
